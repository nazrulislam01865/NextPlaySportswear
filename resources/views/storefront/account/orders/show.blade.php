    ...
    <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_330px] lg:items-start">
        <div class="space-y-6">
            ...
            <section class="grid gap-5 md:grid-cols-2">
                ...
                <div class="rounded-[28px] border border-slate-200 bg-white p-5 shadow-card"><h3 class="font-black">Payment & Delivery</h3><div class="mt-3 grid gap-3 text-sm text-slate-600"><p><b class="text-brand-ink">Payment:</b> {{ data_get($order->payment_method,'label','Not selected') }}</p><p><b class="text-brand-ink">Product shipping:</b> {{ data_get($order->shipping_method,'title','To be confirmed') }}</p><p><b class="text-brand-ink">Estimate:</b> {{ data_get($order->shipping_method,'eta','Updated after production') }}</p></div></div>
            </section>
