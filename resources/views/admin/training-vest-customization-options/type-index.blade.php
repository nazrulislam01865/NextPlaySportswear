        ...
        <div class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_390px]">
                                    ...
                                    <td class="px-5 py-4">
                                        <div class="admin-row-actions">
                                            <a
                                                ...
                                                href="{{ route('admin.training-vest-customization-options.edit', $item) }}?return_type={{ $type->value }}"
                                            >
                                                Edit
                                            </a>
                                            <form
                                                method="POST"
                                                action="{{ route('admin.training-vest-customization-options.destroy', $item) }}"
            ...
            <aside class="rounded-3xl border border-slate-200 bg-white p-5 shadow-card sm:p-6 xl:sticky xl:top-36 xl:self-start">
                ...
                <form
                    ...
                    method="POST"
                    action="{{ route('admin.training-vest-customization-options.store') }}"
