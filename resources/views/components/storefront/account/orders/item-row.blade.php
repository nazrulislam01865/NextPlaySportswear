...
<div class="grid min-w-0 grid-cols-[64px_minmax(0,1fr)] gap-3 rounded-2xl border border-slate-200 bg-white p-3 sm:grid-cols-[80px_minmax(0,1fr)] sm:gap-4 sm:p-4">
    <img src="{{ \App\Support\PublicMedia::url(null, $item->image_url, '/images/product-placeholder.svg') }}" alt="{{ $item->product_name }}" class="h-16 w-16 rounded-xl bg-white object-contain sm:h-20 sm:w-20" loading="lazy">
