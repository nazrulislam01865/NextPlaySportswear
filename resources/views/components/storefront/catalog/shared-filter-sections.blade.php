...
@if(($options['sports'] ?? []) !== [])
    <details class="np-catalog-filter-section" @if($hasSelection('sports')) open @endif>
        ...
        <div class="np-catalog-filter-options @if(count($options['sports']) > $filterScrollThreshold) np-catalog-option-list--scroll @endif">
...
@if(($options['product_types'] ?? []) !== [])
    <details class="np-catalog-filter-section" @if($hasSelection('product_types')) open @endif>
        ...
        <div class="np-catalog-filter-options @if(count($options['product_types']) > $filterScrollThreshold) np-catalog-option-list--scroll @endif">
...
@if(($options['colors'] ?? []) !== [])
    <details class="np-catalog-filter-section" @if($hasSelection('colors')) open @endif>
        ...
        <div class="np-catalog-color-grid @if(count($options['colors']) > $filterScrollThreshold) np-catalog-option-list--scroll np-catalog-option-list--color @endif">
...
@if(($options['moq'] ?? []) !== [])
    <details class="np-catalog-filter-section" @if($hasSelection('moq')) open @endif>
        ...
        <div class="np-catalog-filter-options @if(count($options['moq']) > $filterScrollThreshold) np-catalog-option-list--scroll @endif">
...
@if(($options['customization'] ?? []) !== [])
    <details class="np-catalog-filter-section" @if($hasSelection('customization')) open @endif>
        ...
        <div class="np-catalog-filter-options @if(count($options['customization']) > $filterScrollThreshold) np-catalog-option-list--scroll @endif">
...
@if(($options['artwork_methods'] ?? []) !== [])
    <details class="np-catalog-filter-section" @if($hasSelection('artwork_methods')) open @endif>
        ...
        <div class="np-catalog-filter-options @if(count($options['artwork_methods']) > $filterScrollThreshold) np-catalog-option-list--scroll @endif">
...
@if(($options['materials'] ?? []) !== [])
    <details class="np-catalog-filter-section" @if($hasSelection('materials')) open @endif>
        ...
        <div class="np-catalog-filter-options @if(count($options['materials']) > $filterScrollThreshold) np-catalog-option-list--scroll @endif">
...
@if(($options['availability'] ?? []) !== [])
    <details class="np-catalog-filter-section" @if($hasSelection('availability')) open @endif>
        ...
        <div class="np-catalog-filter-options @if(count($options['availability']) > $filterScrollThreshold) np-catalog-option-list--scroll @endif">
...
@if(($options['rating_options'] ?? []) !== [])
    <details class="np-catalog-filter-section" @if(($filters['min_rating'] ?? null) !== null) open @endif>
        ...
        <div class="np-catalog-filter-options @if(count($options['rating_options']) > $filterScrollThreshold) np-catalog-option-list--scroll @endif">
...
@foreach(($options['attributes'] ?? []) as $attribute)
    <details class="np-catalog-filter-section" @if(count((array) ($filters['attributes'][$attribute['slug']] ?? [])) > 0) open @endif>
        ...
        <div class="np-catalog-filter-options @if(count($attribute['values']) > $filterScrollThreshold) np-catalog-option-list--scroll @endif">
