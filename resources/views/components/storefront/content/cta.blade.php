...
<section class="bg-brand-navy py-14 text-center text-white sm:py-16">
    <div class="site-container">
        ...
        <div class="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
            <a href="{{ $primaryHref ?? route('products.index') }}" class="btn btn-primary">{{ $primaryLabel }}</a>
            <a href="{{ $secondaryHref ?? route('quote.request') }}" class="btn btn-outline">{{ $secondaryLabel }}</a>
        </div>
    </div>
</section>
