<div class="bg-brand-dark text-white">
    <div class="site-container flex flex-col items-center justify-between gap-2 py-2 text-center text-xs font-bold sm:flex-row sm:text-left">
        <p>Custom team uniforms, jerseys, hoodies, caps, bags, and sports gear. Bulk quotes available for teams, schools, clubs, and events.</p>
        <div class="flex flex-wrap justify-center gap-4 whitespace-nowrap sm:justify-end">
