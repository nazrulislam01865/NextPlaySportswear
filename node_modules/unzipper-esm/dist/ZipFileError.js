...
exports.createZipFileError = createZipFileError;
...
var ZipFileError = exports["default"] = /*#__PURE__*/function (_Error) {
  function ZipFileError(code, message) {
    var _this;
    _classCallCheck(this, ZipFileError);
    _this = _callSuper(this, ZipFileError, [message || code]);
    _this.code = code;
    return _this;
  }
  _inherits(ZipFileError, _Error);
  return _createClass(ZipFileError);
}(/*#__PURE__*/_wrapNativeSuper(Error));
function createZipFileError(error) {
  var zipFileError = new ZipFileError(error.code, error.message);
  // Keep original stack if it exists
  if (error.stack) {
    zipFileError.stack = error.stack;
  }
  // Clean up stack trace a bit in Node.js/V8 environments
  Error.captureStackTrace(zipFileError, createZipFileError);
  ...
  //
  zipFileError.cause = error;
  // Return the error.
  return zipFileError;
}
//# sourceMappingURL=ZipFileError.js.map