...
class HomepageSectionService
{
    ...
    private function buildSections(): array
    {
        ...
        // Load both active and inactive rows. If we queried only active rows, an
        // intentionally hidden registry-backed section would look like a missing row
        // and would be restored from its default (active) registry definition.
