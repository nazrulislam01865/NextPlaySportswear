...
class AdminRbac
{
    ...
    public static function permissions(): array
    {
        return [
            ...
            self::permission('customization.view', 'Catalog', 'View', 'View Customization Master Data', 'Open jersey customization options and size option groups.', 'admin.jersey-customization-options.index', 50),
            self::permission('customization.manage', 'Catalog', 'Manage', 'Manage Customization Master Data', 'Create and update jersey customization options and size option groups.', 'admin.jersey-customization-options.store', 51),
