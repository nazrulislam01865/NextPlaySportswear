...
class ProductFilterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'genders' => ['nullable', 'array', 'max:20'],
            'genders.*' => ['integer', 'distinct', Rule::exists('genders', 'id')->where(fn ($query) => $query->where('is_active', true))],
    ...
    public function filters(): array
    {
        ...
        return [
            ...
            'genders' => $this->integerArray($validated['genders'] ?? []),
