...
class TrainingVestSizeOptionGroupRequest extends FormRequest
{
    ...
    {
        $group = $this->route('trainingVestSizeOptionGroup');
        ...
        return [
            ...
            'slug' => [
                ...
                'string',
                'max:180',
                Rule::unique('training_vest_size_option_groups', 'slug')->ignore($group?->getKey()),
            ],
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'is_active' => true,
            'sort_order' => $group instanceof TrainingVestSizeOptionGroup ? (int) $group->sort_order : 0,
            'sizes' => $sizes,
        ]);
    }
}
