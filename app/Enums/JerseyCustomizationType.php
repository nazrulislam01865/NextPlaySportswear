...
enum JerseyCustomizationType: string
{
    ...
    public function group(): string
    {
        return match ($this) {
            ...
            self::JerseyPipingOption => 'jersey',
            self::ShortsColor,
            self::ShortsFabric,
            self::ShortsSize,
            ...
            self::ShortsImprintOption => 'shorts',
            self::UniformType,
            self::UniformStyle,
            self::UniformFabric,
            ...
            self::HoodieImprintAreaOption => 'hoodie',
            self::PoloColor,
            self::PoloFabric,
            ...
            self::CompressionWearImprintOption => 'compression_wear',
            self::SocksColor,
            self::SocksPattern,
            ...
            self::HeadwearFabricOption => 'headwear',
    ...
    public function helpText(): string
    {
        return match ($this) {
            ...
            self::PoloImprintMethodOption => 'Add polo-only imprint method choices such as screen print, heat transfer, embroidery, or sublimation. These values stay separate from imprint options and from other product groups.',
            ...
            self::PoloImprintOption => 'Add polo-only imprint choices used during product configuration. These values stay separate from imprint methods and from jersey, shorts, hoodie, T-shirt, and other imprint master data.',
    ...
    public function imageTitle(): string
    {
        return match ($this) {
            ...
            self::JerseyLogoOption => 'Optional logo reference image',
            self::JerseyPipingOption => 'Optional piping reference image',
            self::ShortsRopeOption => 'Optional rope reference image',
            self::ShortsElasticWaistDrawcordOption => 'Optional waist/drawcord reference image',
            self::ShortsImprintOption => 'Optional imprint reference image',
    ...
    public function imageDescription(): string
    {
        return match ($this) {
            ...
            self::JerseyLogoOption => 'Optional. Add a clear jersey logo reference image when helpful.',
            self::JerseyPipingOption => 'Optional. Add a close-up showing the piping placement or finish.',
            self::ShortsRopeOption => 'Optional. Add a close-up when the rope or drawstring style needs a visual preview.',
            self::ShortsElasticWaistDrawcordOption => 'Optional. Add a close-up showing the elastic waist and drawcord construction.',
            self::ShortsImprintOption => 'Optional. Add an imprint-method reference image when the shorts finish needs a visual preview.',
            ...
            self::PoloImprintMethodOption => 'Optional. Add a polo imprint-method reference image when the application technique needs a visual preview.',
    ...
    public function imageCta(): string
    {
        return match ($this) {
            ...
            self::JerseyLogoOption => 'Choose logo image',
            self::JerseyPipingOption => 'Choose piping image',
            self::ShortsRopeOption => 'Choose rope image',
            self::ShortsElasticWaistDrawcordOption => 'Choose waist/drawcord image',
            self::ShortsImprintOption => 'Choose imprint image',
