...
test('audience tiles match the full-width prototype proportions', () => {
  ...
  for (const declaration of [
    ...
    '--np-audience-title-weight: var(--np-weight-bold)',
...
test('hero banner copy and controls stay centralized while matching the approved compact reference', () => {
  ...
  for (const declaration of [
    ...
    '--np-home-hero-eyebrow-size: 13px',
    '--np-home-hero-eyebrow-weight: var(--np-weight-semibold)',
    '--np-home-hero-title-font-family: var(--np-font-display)',
    '--np-home-hero-title-size-mobile: 34px',
    '--np-home-hero-title-weight: var(--np-weight-bold)',
    '--np-home-hero-copy-font-family: var(--np-font-body)',
    '--np-home-hero-copy-size: clamp(14px, .84vw, 17px)',
    '--np-home-hero-copy-size-mobile: 14px',
    '--np-home-hero-copy-weight: var(--np-weight-medium)',
    '--np-home-hero-action-font-family: var(--np-font-display)',
    '--np-home-hero-action-size: 14px',
    '--np-home-hero-action-size-mobile: 13px',
    '--np-home-hero-action-weight: var(--np-weight-semibold)',
    '--np-home-hero-action-min-width: 168px',
    '--np-home-hero-action-height: 54px',
    '--np-home-hero-action-padding-inline: 25px',
    ...
    '--np-home-hero-control-size: 52px',
    '--np-home-hero-control-track-width: 70px',
    '--np-home-hero-control-icon-size: 14px',
